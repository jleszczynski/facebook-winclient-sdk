...
namespace Facebook.Client
{
    public partial class FacebookDialogPage : PhoneApplicationPage
    {
        ...
        private WebDialogStatus responseStatus = WebDialogStatus.UserCancel;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (!WebDialogBroker.DialogInProgress)
            {
            ...
            if (!dialogStarted)
            {
                ...
                browserControl.Source = WebDialogBroker.StartUri;
            }
        }
        ...
        {
            // If there is an active authentication operation in progress and we havedialog
            ...
            // the start screen.
            if (WebDialogBroker.DialogInProgress && dialogFinished)
            {
                dialogStarted = false;
                dialogFinished = false;

                WebDialogBroker.OnDialogFinished(responseData, responseStatus, responseErrorDetail);
            }
        }
        ...
        {
            if (e.Uri == WebDialogBroker.EndUri)
            {
